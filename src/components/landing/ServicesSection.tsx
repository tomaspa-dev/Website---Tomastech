...
const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    shortDesc: "App-like experiences in the browser — offline capable, installable, and blazing fast on any device.",
    gradient: "from-purple-400 to-purple-600",
    glow: "rgba(192, 132, 252, 0.15)",
    iconColor: "text-purple-400",
    modalTitle: "Progressive Web Applications (PWA)",
    modalDesc: "We create Progressive Web Apps that combine the best of web and native apps — installable on any device, work offline, send push notifications, and deliver native-app performance without app store distribution.",
    features: ["Offline-first architecture", "Push notifications", "Installable on any device", "Background sync", "Camera & sensor access", "Native-like performance"],
    techStack: ["Service Workers", "Web App Manifest", "IndexedDB", "Workbox / Vite PWA"],
    useCases: ["Field workforce tools", "E-commerce mobile experience", "Offline-capable dashboards", "Customer-facing apps"],
  },
  {
    icon: Globe,
    title: "Landing Pages",
  ...
  },
  {
    ...
    techStack: ["Figma", "Adobe Creative Suite", "Framer", "Storybook"],
